...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 22. Nov 2022 um 18:01
...
CREATE TABLE `gerichte` (
  ...
  `mitarbeiterpreis` int(11) NOT NULL,
  `gästepreis` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `gerichte` (`gerichtNr`, `name`, `mitarbeiterpreis`, `gästepreis`) VALUES
(1, 'Pommes Frittes', 3, 3),
(2, 'Schnitzel mit Kartoffelsalat', 6, 8),
(3, 'Schweinebraten', 8, 9),
(4, 'Gemischter bunter Salat', 5, 6),
(5, 'Gemüselasagne', 4, 5),
(6, 'Currywurst mit Pommes', 6, 7),
(7, 'Beilagensalat', 2, 3),
(8, 'Gebratene Nudeln', 4, 5),
(9, 'Gemüsesuppe', 2, 3),
(10, 'Pizza', 6, 7);
...
--
-- Tabellenstruktur für Tabelle `verkauft`
--

CREATE TABLE `verkauft` (
  `gericht` int(11) NOT NULL,
  `mitarbeiter` int(11) NOT NULL,
  `menge` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Daten für Tabelle `verkauft`
--

INSERT INTO `verkauft` (`gericht`, `mitarbeiter`, `menge`) VALUES
(5, 4, 1),
(5, 25, 1),
(9, 1, 1),
(2, 23, 2),
...
--
-- Indizes für die Tabelle `verkauft`
--
ALTER TABLE `verkauft`
  ADD PRIMARY KEY (`gericht`,`mitarbeiter`),
  ADD KEY `menge` (`menge`),
  ADD KEY `verkauft_ibfk_2` (`mitarbeiter`);
...
--
-- Constraints der Tabelle `verkauft`
--
ALTER TABLE `verkauft`
  ADD CONSTRAINT `verkauft_ibfk_1` FOREIGN KEY (`gericht`) REFERENCES `gerichte` (`gerichtNr`),
  ADD CONSTRAINT `verkauft_ibfk_2` FOREIGN KEY (`mitarbeiter`) REFERENCES `mitarbeiter` (`mitarbeiterNr`);
COMMIT;
